...
var CurrentPageIdentifier = {
	...
	run: function(pageNavId) {
		CurrentPageIdentifier.removeLinkOfCurrentPage(pageNavId);
	},
	
	removeLinkOfCurrentPage: function(pageNavId) {
		var prefix = '#';
		var currentPage = prefix.concat(pageNavId);
		var uppercaseNavName = pageNavId.toUpperCase();
		$(currentPage).replaceWith(uppercaseNavName);
	},
